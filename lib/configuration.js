        ...
        switch (statement.type) {
            ...
            case Statement.INCLUDE:
                ...
                if (includeFiles[includeFile]) {
                    throw new Error('Include error: Cyclic dependency ignored');
                } else {
            ...
            case Statement.ARRAY:
                var arrayName = statement.value.name;
                section[arrayName] = [].concat(section[arrayName] || [], statement.value.parameter);
                break;
        }
    }
